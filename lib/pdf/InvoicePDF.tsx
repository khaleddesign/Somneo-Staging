...
Font.register({
  ...
  fonts: [
    {
      src: path.join(process.cwd(), "public/fonts/Syne-Regular.ttf"),
      fontWeight: 400,
    },
    {
      src: path.join(process.cwd(), "public/fonts/Syne-SemiBold.ttf"),
      fontWeight: 600,
    },
    {
      src: path.join(process.cwd(), "public/fonts/Syne-Bold.ttf"),
      fontWeight: 700,
    },
  ],
});
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.table}>
          ...
          {studies.map((study, index) => {
            ...
            return (
              ...
              >
                <Text
                  style={[styles.td, styles.colDesignation]}
                >{`Analyse ${study.study_type} — ${patient}`}</Text>
                ...
                <Text style={[styles.tdPrice, styles.colPrice]}>
                  {formatMoney(price)}
                </Text>
              </View>
            );
        ...
        <View style={styles.totalsWrap}>
          <View style={styles.totalLine}>
            ...
            <Text style={styles.totalValue}>
              {formatMoney(invoice.subtotal_ht)}
            </Text>
          </View>
          <View style={styles.totalLine}>
        ...
        <View style={styles.paymentBox}>
          ...
          >{`Référence virement : ${invoice.invoice_number}`}</Text>
        </View>

        <Text style={styles.legal}>
          Pénalités retard : indemnité forfaitaire et intérêts de retard
          applicables après échéance.
        </Text>
        <Text style={styles.legal}>
          TVA non applicable hors UE : export de services depuis UAE.
        </Text>
        <Text style={styles.legal}>
          RGPD : les données patient sont traitées de manière strictement
          confidentielle.
        </Text>
