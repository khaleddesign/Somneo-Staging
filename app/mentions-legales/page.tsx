    ...
    <div className="min-h-screen bg-gray-50 py-16 px-4">
      <div className="max-w-3xl mx-auto bg-white p-10 rounded-2xl shadow-sm border border-gray-100">
        ...
        <div className="space-y-6 text-gray-600 font-body">
          ...
          <section>
            <h2 className="text-xl font-semibold text-midnight mb-3">
              2. Hosting and Health Data
            </h2>
            <p>
              The application is hosted on the Vercel serverless infrastructure
              (European Union).
            </p>
            <p>
              Database and file storage are operated by{" "}
              <strong>Supabase</strong>
              on AWS servers in Europe (Frankfurt, Germany / eu-central-1),
              complying with strict security and confidentiality standards.
            </p>
            <p>
              Personal data and patient records are hosted in accordance with
              applicable Healthcare Data Hosting (HDS) guidelines.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              (texts, images, logos, architecture, code) are protected by
              intellectual property law. Any reproduction is strictly prohibited
          ...
          <section>
            ...
            <p>
              The publisher strives to ensure the accuracy and update of the
              information published on this site, and reserves the right to
              correct the content. However, SomnoConnect cannot be held liable
              for temporary unavailability of the platform or data losses caused
