          ...
          <table className="min-w-full text-sm">
            ...
            <tbody>
              {sortedInvoices.map((invoice) => (
                ...
                >
                  <td className="px-3 py-3 font-heading text-midnight">
                  ...
                  <td className="px-3 py-3">
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-heading ${statusUi(invoice.status)}`}
                    >
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          void updateStatus(
                            invoice.id,
                            value as Exclude<InvoiceStatus, "draft">,
                          )
                        }
