              ...
              <tbody>
                {filtered.map((client) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-3 font-body">
                      {client.studies_count || 0}
                    </td>
                    <td className="px-3 py-3 font-body">
                      {client.last_study_at
                        ? new Date(client.last_study_at).toLocaleDateString(
                            "en-GB",
                          )
                        : "—"}
                    </td>
                    <td className="px-3 py-3">
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-heading ${client.is_suspended ? "bg-red-100 text-red-700" : "bg-green-100 text-green-700"}`}
                      >
                    ...
                    <td className="px-3 py-3">
                      <div className="flex flex-wrap gap-2">
                        ...
                        >
                          ...
                          {client.is_suspended ? "Reactivate" : "Suspend"}
                        </Button>
                      </div>
                    </td>
                  </tr>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setInviteForm((s) => ({ ...s, full_name: e.target.value }))
                }
              />
            </div>
            <div>
            ...
            <Button
              ...
              disabled={submittingInvite || !inviteForm.email.trim()}
            >
