...
export default function AdminAgentsPage() {
  ...
  async function deleteAgent(agent: Agent) {
    if (
      !window.confirm(
        t("deleteConfirm", { name: agent.full_name || agent.email }),
      )
    )
      return;
                ...
                {filtered.map((agent) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-3">
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-heading ${agent.is_suspended ? "bg-red-100 text-red-700" : "bg-green-100 text-green-700"}`}
                      >
                    ...
                    <td className="px-3 py-3">
                      <div className="flex flex-wrap gap-2">
                        <Link
                          href={`/dashboard/admin/studies?agent=${agent.id}`}
                        >
                          <Button
                            variant="outline"
                        ...
                        >
                          ...
                          {agent.is_suspended ? t("reactivate") : t("suspend")}
                        </Button>
                        <Button
