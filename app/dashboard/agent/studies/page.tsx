  ...
  return (
    <AppLayout>
      <div className="p-8 bg-[#f0f4f8]">
        <h1 className="text-4xl text-midnight font-display mb-8">Studies</h1>

        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            <h2 className="text-xl text-midnight font-heading">
              Available study pool
            </h2>
            <span className="bg-teal/10 text-teal font-heading text-sm px-3 py-1 rounded-full">
              {poolStudies.length} study{poolStudies.length !== 1 ? "s" : ""}{" "}
              available
            </span>
          </div>
        ...
        <section className="mb-10">
          <h2 className="text-xl mb-4 text-midnight font-heading">
            My studies en cours
          </h2>
          <StudyListWithFilters
