...
export function StudySearchCombobox({ onSelect, initialCandidates = [], disabled }: StudySearchComboboxProps) {
        ...
        <ul className="absolute z-50 mt-1 w-full bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden max-h-52 overflow-y-auto">
          {results.map(study => (
            <li key={study.id}>
              ...
              >
                <span className="text-sm font-medium text-gray-900">{study.patient_reference}</span>
