...
interface BatchEDFFileRowProps {
  ...
  onUpdate: (
    id: string,
    patch: Partial<
      Pick<BatchFileItem, "patientRef" | "studyType" | "priority" | "notes">
    >,
  ) => void;
...
export function BatchEDFFileRow({
  item,
  index,
  onUpdate,
  onRemove,
  disabled,
}: BatchEDFFileRowProps) {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(e) =>
                onUpdate(item.id, { patientRef: e.target.value })
              }
          ...
          <div className="space-y-1">
            ...
            <Select
              ...
              onValueChange={(v) =>
                onUpdate(item.id, { studyType: v as StudyType })
              }
              disabled={fieldDisabled}
            >
              <SelectTrigger
                className={`text-sm ${!item.studyType && disabled ? "border-red-300" : "border-gray-200"}`}
              >
              ...
              <SelectContent>
                ...
                <SelectItem value="MSLT">
                  MSLT — Test de latence multiple
                </SelectItem>
                <SelectItem value="MWT">
          ...
          <div className="space-y-1">
            ...
            <Select
              value={item.priority}
              onValueChange={(v) =>
                onUpdate(item.id, { priority: v as Priority })
              }
              disabled={fieldDisabled}
            >
